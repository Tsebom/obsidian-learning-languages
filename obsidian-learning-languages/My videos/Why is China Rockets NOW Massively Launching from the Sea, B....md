...
datawords: service/data/video/data-29.10.2025-23-34-57.md
quiz: service/quiz/quiz-29.10.2025-23-34-57.md
link: "https://www.youtube.com/watch?v=aXEd3N_NHKQ"
completed: false
tags:
  - video
---
...
action:
 type: inlineJS
 code: "if (confirm('Are you sure you want to delete this file?')) {await app.vault.adapter.remove('service/quiz/quiz-29.10.2025-23-34-57.md');await app.vault.adapter.remove('service/data/video/data-29.10.2025-23-34-57.md');await app.vault.adapter.remove('My videos/Why is China Rockets NOW Massively Launching from the Sea, B....md');}"
hidden: true
```
```meta-bind-button
style: primary 
...
action:
 type: inlineJS
 code: "app.workspace.openLinkText('service/quiz/quiz-29.10.2025-23-34-57.md', '/', false);"
hidden: true
```
