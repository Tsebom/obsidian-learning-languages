...
action:
 type: inlineJS
 code: "const file = app.workspace.getActiveFile();const path = file.path;window.showPopupDeleteFile('Are you sure you want to delete this file?', 'service/quiz/{{quizFile}}', 'service/data/{{dataFile}}', path)"
hidden: true
```
```meta-bind-button
style: primary
